function data = read_ldata_forward_sim(analysis_dir, correct)
%READ_LDATA read the labeling data and correct for natural abundance of
%stable isotopes.
...
DATA_FNAME = 'labeling_forward.csv';
