...
void kfpdxode(double t, double *dX, size_t dX_len, mxArray *X, mxArray *Y, 
        mxArray *dY, double *A, double *B, double *C_diag, double *dC_diag, 
        int *A_inds, double *ddXdt)
{
    int i, j, i1;
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    dC_diag = mxGetPr(mxGetField(prhs[2], 0, "dC_diag"));
    ...
    kfpdxode(t, dX, dX_len, X, Y, dY, A, B, C_diag, dC_diag, A_inds, 
            ddXdt);
