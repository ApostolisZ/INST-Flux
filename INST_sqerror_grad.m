function dsqerror = INST_sqerror_grad(x, emumodel, ldata, nz_isos, mids)
%INST_SQERROR_GRAD calculates the gradient of the objective function
%   DSQERROR = INST_SQERROR_GRAD(X, EMUMODEL,LDATA,NZ_ISOS,MIDS) calculates
%   the gradient of the objective function. 
%   DSQERROR is a vector with the partial derivative of the objective
%   with respect to a decision variable. 
